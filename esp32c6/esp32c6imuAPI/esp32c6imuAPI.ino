...
curl GET 'http://192.168.1.76/aZ'
curl --location 'http://192.168.1.76/config' \
...
void handlePost() {
  ...
  String valConfig = jsonDocument["config"];

  // envoie sur la valeur sur la LED.
  if(valConfig == "ip"){
    Serial.print("test de commande adresse ip  ");
    Serial.println();
  }
  if(valConfig == "unit"){
    Serial.print("test de commande unit   ");
    Serial.println();
  }
